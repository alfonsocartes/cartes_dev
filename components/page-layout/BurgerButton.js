const BurgerButton = ({ toggleFunction }) => (
  <button
    className="lg:hidden bg-opacity-40 border-white border-opacity-20 border rounded-lg shadow-lg text-gray-900 bg-gray-300 dark:bg-gray-200 hover:bg-gray-500 dark:hover:bg-gray-500 pl-2 h-8 w-8 mr-4"
    type="button"
