...
# This is going to be a post for the portfolio, explaning how the app is made, what technologies are used and why.  

# This is not going to be the actual landing page of the app.
