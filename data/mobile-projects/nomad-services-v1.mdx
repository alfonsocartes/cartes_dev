...
coverImage:
  url: "/assets/projects/nomad-services-v1/nomad-services-v1-icon.jpg"
  width: 1024
  height: 1024
  containerWidth: 256
  containerHeight: 256
...
The app uses a colour scheme found in the _constants.dart_ file.

<Carousel post="nomad-services-v1" />
...
I use Firestore from Firebase to store the data for each place and the collection of places. You can find the implementation in the files that end in _\_data.dart_ in the _model_ folder

## Why Flutter?

I picked Flutter because I wanted to make a simple app that used Firestore and a Map Widget. It takes a lot of code from the [AnyLeft project](http://www.cartes.dev/portfolio/mobile-development/mobile-projects/anyleft-v1)
...
[Take a look at the code on GitHub](https://github.com/alfonsocartes`)
...
This is the folder where the classes of each type of service are. Also, the implementation of the Firestore data handling can be found in the files that end in _\_data.dart_
