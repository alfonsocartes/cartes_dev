...
coverImage: 
  url: "/assets/blog/why-flutter-for-your-business/flutter-cover.jpg"
  width: 800
  height: 311
ogImage:
  url: "/assets/blog/why-flutter-for-your-business/flutter-cover.jpg"
...
This last part: _"single codebase"_ is essential. With one codebase, [one development team, and one design team](https://www.cartes.dev/about/), you can get a [native app that works on iOS, Android, Desktop, and the Web.](https://www.cartes.dev/portfolio/)
...
There are also other popular cross-platform development SDKs like [React Native](https://www.cartes.dev/portfolio/) and [Xamarin](https://dotnet.microsoft.com/apps/xamarin). They also do not rely on a web layer.
