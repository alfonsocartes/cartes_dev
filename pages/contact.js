        ...
        <div className="lg:w-1/2 md:w-2/3 mx-auto">
          <div className="flex flex-wrap -m-2">
            ...
            <div className="p-2 w-full">
              <button
                type="submit"
                className="flex mx-auto frosted bg-opacity-40 border-white border-opacity-20 border rounded-lg shadow-lg bg-gray-300  hover:bg-gray-300 dark:hover:bg-gray-600  py-2 px-8 focus:outline-none text-lg"
              >
                Send
              </button>
            </div>
