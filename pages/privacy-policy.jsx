      ...
      <div className="flex flex-col items-center">
        <article className="prose dark:prose-invert">
          ...
          <p>
            ...
            media form, media channel, mobile website, or mobile applications
          ...
          <p>
            ...
            activities related to the Site and our mobile applications, such as
          ...
          <p>
            ...
            applications. We store only very limited, if any, financial
            information that we collect. Otherwise, all financial information is
            stored by our payment processors, and you are encouraged to review
            their privacy policy and contact them directly for responses to your
            questions.
          </p>
          <h3>Data From Social Networks </h3>
          <p>
            User information from social networking sites, such as, but not
            limited to Apple’s Game Center, Facebook, Instagram, Pinterest,
            Twitter, including your name, your social network username,
            ...
            networks. If you are using our mobile applications, this information
            may also include the contact information of anyone you invite to use
            and/or join our mobile application.
          </p>
          ...
          <p>
            ...
            do so in your device’s settings. Mobile Device Data. We may collect
            device information (such as your mobile device ID, model and
          ...
          <p>
            ...
            the Site and our mobile applications. <br />
            ...
            Solicit support for the Site and our mobile applications. <br />
          </p>
          ...
          <p>
            ...
            applications, those users may see your name, profile photo, and
          ...
          <p>
            ...
            visit the Site or our mobile applications. These companies may use
            information about your visits to the Site and our mobile
            applications and other websites that are contained in web cookies in
          ...
          <h3>Offer Wall </h3>
          <p>
            Our mobile applications may display a third-party hosted “offer
            ...
            mobile application. A unique identifier, such as your user ID, will
            be shared with the offer wall provider in order to prevent fraud and
            properly credit your account.
          </p>
          <h3>Social Media Contacts </h3>
          <p>
            If you connect to the Site or our mobile applications through a
          ...
          <p>
            ...
            technologies on the Site and our mobile applications to help
            customize the Site and our mobile applications and improve your
            experience. When you access the Site or our mobile applications,
            your personal information is collected through the use of tracking
            ...
            applications. You may not decline web beacons. However, they can be
            rendered ineffective by declining all cookies or by modifying your
            web browser’s settings to notify you each time a cookie is tendered,
          ...
          <p>
            ...
            Site and our mobile applications, implement email marketing
            ...
            to help manage and optimize your online experience with us. For more
          ...
          <p>
            ...
            tracking technologies and remarketing services on the Site and our
            mobile applications through the use of first party cookies and
            third-party cookies, to, among other things, analyze and track
            users’ use of the Site and our mobile applications , determine the
            popularity of certain content and better understand online activity.
            By accessing the Site,our mobile applications, you consent to the
          ...
          <p>
            The Site and our mobile applications may contain links to
            ...
            applications, any information you provide to these third parties is
            ...
            the Site or our mobile applications.
          </p>
          ...
          <p>
            ...
            applicationss include a Do-Not-Track (“DNT”) feature or setting you
            ...
            and our mobile applications include a Do-Not-Track (“DNT”) feature
          ...
          <p>
            ...
            Contacting us using the contact information provided below. Upon
